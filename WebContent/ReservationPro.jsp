...
<body>
	...
	reservdb.insertreserv(reservbean);
	%>
    ...
    <form>
        <table>
        	<tr>
        		<th id="t_title" colspan="3">예약이 완료되었습니다.</th>
        	</tr>
            <tr>
                <th>날짜</th>
                <td colspan="2"><%=reservbean.getDate() %></td>       
            </tr> 
            <tr>
                <th>테마</th>
                <td colspan="2"><%=reservbean.getTheme() %></td>       
            </tr> 
            <tr>
                <th>시간</th>
                <td colspan="2"><%=reservbean.getTime() %></td>       
            </tr> 
            <tr>
                <th>인원</th>
                <td colspan="2"><%=reservbean.getNum()%></td>       
            </tr> 
            <tr>
                <th>이름</th>
                <td colspan="2"><%=reservbean.getName() %></td>       
            </tr> 
            <tr>
                <th>연락처</th>
                <td colspan="2"><%=reservbean.getPhone() %></td>       
            </tr> 
            <tr>
                <th>비고</th>
                <td colspan="2"><%=reservbean.getNote() %></td>       
            </tr> 
			<tr>
				<td colspan="3">
				<input type="button" class="btn btn-primary" value="확인" onClick="location='main.jsp'">
				</td>
			</tr>       
        </table>
    </form>
