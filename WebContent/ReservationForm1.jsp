...
<body>
	...
	<form action="ReservationForm2.jsp" method="post" name="reserInfo" onsubmit="return checkReserv1()">
        <table>
        	<tr>
                <th id="t_title" colspan="3">테마 선택</th>     
            </tr>
            <tr>
                <td colspan="3">
                <table>
                <tr>
	                <td><input type="radio"  name="theme" value="PC방가는길">PC방가는 길<img src="img/theme1.jpg" width=150></td>
	               	<td><input type="radio"  name="theme" value="괴짜중딩">괴짜중딩<img src="img/theme2.jpg" width=150></td>
	                <td><input type="radio"  name="theme" value="파커vs파커">파커vs파커<img src="img/theme3.jpg" width=150></td>
	                <td><input type="radio"  name="theme" value="8585세탁소">8585세탁소<img src="img/theme4.jpg" width=150></td>
    			</tr>  
    			</table>
    			</td>
            </tr>
