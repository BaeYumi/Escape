...
<body>
        ...
        <table>
            <tr>
                <td id="t_title" colspan="3">
                	<b><%=session.getAttribute("sessionID") %></b> 님 로그인 되었습니다.
                </td>
            </tr> 
            <tr>
                <td colspan="3">
                <input type="submit" class="btn btn-primary" value="홈으로">
                <input type="button" class="btn btn-danger" value="로그아웃" onClick="location.href='LogoutPro.jsp'">
                </td>
            </tr>
    <%
	...
	%>		
			<tr>
				<td colspan="3">
				<input type="button" class="btn btn-primary" value="관리자 페이지 접속" onClick="location.href='adminlist.jsp'">
				</td>
			</tr>   
	<%
			}
